   ...
   if( coef[ "rho" ] == 0 ) {
      ...
      if( coef[ "rho_2" ] == 0 ) {
         result <- exp( - ( coef[ "nu" ] / coef[ "rho" ] ) *
            log( coef[ "delta_3" ] * exp( coef[ "rho" ] * 
               ( - coef[ "delta_1" ] * log( data[[ xNames[ 1 ] ]] ) -
                  ( 1 - coef[ "delta_1" ] ) * log( data[[ xNames[ 2 ] ]] ) ) ) +
            ( 1 - coef[ "delta_3" ] ) * exp( coef[ "rho" ] * 
               ( - coef[ "delta_2" ] * log( data[[ xNames[ 3 ] ]] ) -
                  ( 1 - coef[ "delta_2" ] ) * log( data[[ xNames[ 4 ] ]] ) ) )
            ) )
      } else {
   ...
   if( coef[ "rho" ] == 0 ) {
      ...
      result <- - coef[ "gamma" ] * coef[ "nu" ] * coef[ "delta_3" ] * 
         ...
         exp( - coef[ "rho" ] *
            ( coef[ "delta_1" ] * log( data[[ xNames[ 1 ] ]] ) +
               ( 1 - coef[ "delta_1" ] ) * log( data[[ xNames[ 2 ] ]] ) ) ) *
         ( - 0.5 * ( - coef[ "delta_1" ] * log( data[[ xNames[ 1 ] ]] ) -
   ...
   if( coef[ "rho" ] == 0 ) {
      ...
      result <- - coef[ "gamma" ] * coef[ "nu" ] * ( 1 - coef[ "delta_3" ] ) * 
         ...
         exp( - coef[ "rho" ] *
            ( coef[ "delta_2" ] * log( data[[ xNames[ 3 ] ]] ) +
               ( 1 - coef[ "delta_2" ] ) * log( data[[ xNames[ 4 ] ]] ) ) ) *
         ( - 0.5 * ( - coef[ "delta_2" ] * log( data[[ xNames[ 3 ] ]] ) -
   ...
   if( coef[ "rho" ] == 0 ) {
      ...
      if( coef[ "rho_2" ] == 0 ) {
         result <- - ( coef[ "gamma" ] / coef[ "rho" ] ) * 
            log( ( 1 - coef[ "delta_3" ] ) * exp( coef[ "rho" ] *
                  ( - coef[ "delta_2" ] * log( data[[ xNames[ 3 ] ]] ) -
                     ( 1 - coef[ "delta_2" ] ) * log( data[[ xNames[ 4 ] ]] ) ) ) +
               coef[ "delta_3" ] * exp( coef[ "rho" ] *
                  ( - coef[ "delta_1" ] * log( data[[ xNames[ 1 ] ]] ) -
